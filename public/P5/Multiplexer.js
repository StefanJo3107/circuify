class Mux extends Element {
    ...
    show = (pos, cellSize) => {
        ...
        line(pos.x, pos.y + cellSize, pos.x + cellSize, pos.y + cellSize);
        line(
            pos.x,
            pos.y + 3 * cellSize,
            pos.x + cellSize,
        ...
        this.outputs[0].show(
            createVector(pos.x + 4 * cellSize, pos.y + 2 * cellSize),
            cellSize / 2,
            cellSize,
            this.state
        );
        ...
        vertex(pos.x + 3 * cellSize, pos.y + 3 * cellSize);
        vertex(pos.x + cellSize, pos.y + 4 * cellSize);
        endShape(CLOSE);
        ...
        fill(0);
        textFont("Helvetica");
        text("0", pos.x + 1.2 * cellSize, pos.y + 1.2 * cellSize);
        text("1", pos.x + 1.2 * cellSize, pos.y + 3.2 * cellSize);
    };
